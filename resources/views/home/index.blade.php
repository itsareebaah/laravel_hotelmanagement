...
@endif
    ...
    <div id="gallary" class="text-center bg-dark text-light has-height-md middle-items wow fadeIn">
        <h2 class="section-title">Food we serve</h2>
    </div>
    ...
    <div class="container-fluid has-bg-overlay text-center text-light has-height-lg middle-items" id="book-table">
        <div class="">
            ...
            <div class="row mb-5">
                ...
                <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                    <input type="number" id="booktable" name="n_guest" class="form-control form-control-lg custom-form-control" placeholder="NUMBER OF GUESTS" max="20" min="0">
                </div>
                <div class="col-sm-6 col-md-3 col-xs-12 my-2">
            ...
            <input type="submit" href="#" class="btn btn-lg btn-primary" id="rounded-btn" value="Book Table">
              </form>
        </div>
    </div>
    ...
    <div id="blog" class="container-fluid bg-dark text-light py-5 text-center wow fadeIn">
        <h2 class="section-title py-5">Our Food</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-transparent border my-3 my-md-0">
                            <img height="200" src="food_img/{{$data->image}}" alt="Can't load">
                            <div class="card-body">
                                <h1 class="text-center mb-4"><a href="#" class="badge badge-primary">{{$data->title}}</a></h1>
                                <h4 class="pt20 pb20">{{$data->price}} </h4>
                                <p class="text-white">{{$data->detail}}</p>
                            </div>
                            <form action="{{url('add_cart',$data->id)}}" method="POST">
                           @csrf
                                <input type="number" min="1" value="1" class="form-control d-inline-block" name="qty" style="width: 80px; height: 38px; border-radius: 0.375rem;">
